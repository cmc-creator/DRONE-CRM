  ...
  return (
    <div className="min-h-screen bg-slate-50">
          ...
          <div className="prose prose-slate max-w-none space-y-8 text-slate-700">
            ...
            <section>
              ...
              <p>
                ...
                is prohibited. This CRM platform is a proprietary product of NyxCollective™. All platform
              ...
              <p className="mt-3">
                © 2026 NyxCollective™ · All rights reserved. Built for Lumin Aerial LLC.
              </p>
              <p className="mt-3">
      ...
      <footer className="text-center text-slate-400 text-xs py-8">
        © 2026 NyxCollective™ · All Rights Reserved ·{" "}
